...
INSERT INTO `dances` (`dance_ID`, `name`, `region`, `style`, `description`, `status`, `image`, `MimeType`) VALUES
(1, 'Tango', 'Mexico', 'Tango', 'Dance', 0, '', NULL),
(2, 'example dance', 'Mexico', 'Southern', 'This is an example dance', 0, '', NULL),
(3, 'example dance', 'Mexico', 'Western', 'This is an example dance', 0, '', NULL);
-- --------------------------------------------------------
